...
decaf.extend(S3Client.prototype, {
    ...
    /**
     * Create bucket, if necessary, and attach a Bucket to S3Client instance at [bucket].
     *
     ...
     * ```
     * @param {String} bucket name of bucket to use (and create if not already existing)
     */
    use             : function (bucket) {
        var me = this;
